    ...
    win.UIO.page = (function () {
        return {
            ...
            pageReposition : function () {
                for (var i = 0, max = win.UIO.Common.Pageobj.length; i < max; i++) {
                    win.UIO.Common.Pageobj[i].reInit();
                }
            },
